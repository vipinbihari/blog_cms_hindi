...
export const BLOG_CONFIG: BlogConfig = {
  ...
  theme: {
    colors: {
      primary: THEME_PRESETS.teal.primary,
      secondary: THEME_PRESETS.teal.secondary,
    },
    typography: {
      fontFamily: {
  ...
  social: [
   ...
   { platform: 'facebook', url: `https://facebook.com/gyanso.official`, label: 'फेसबुक पर लाइक करें' },
